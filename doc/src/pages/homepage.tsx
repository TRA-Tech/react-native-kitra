                ...
                <div className='content-container'>
                    ...
                    <div className='button-container'>
                        ...
                        <button
                            ...
                            Github
                            <svg width="13.5" height="13.5" className='link-icon' aria-hidden="true" viewBox="0 0 24 24" class="iconExternalLink_node_modules-@docusaurus-theme-classic-lib-theme-Icon-ExternalLink-styles-module"><path fill="currentColor" d="M21 13v10h-21v-19h12v2h-10v15h17v-8h2zm3-12h-10.988l4.035 4-6.977 7.07 2.828 2.828 6.977-7.07 4.125 4.172v-11z"></path></svg>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div className='features-container'>
                    ...
                    <div className='features-text'>
                        ...
                        <div className='features-description'>
                            Optimized UI elements for a wonderful mobile user experience.<br />Bring your React Native apps to the next level.
                        </div>
                    </div>
                </div>
            </div>
